...
export function forwardSHT(N, data, CART_OR_SPH, DIRECT_OR_PINV) {
...
export function inverseSHT(coeffs, aziElev) {
...
// xxxxxxxxxxxxxxxxxx
export function print2Darray(array2D) {
...
export function convertCart2Sph(xyz, OMIT_MAG) {
...
export function convertSph2Cart(aziElevR) {
...
export function computeRealSH(N, data) {
...
export function recurseLegendrePoly(n, x, Pnm_minus1, Pnm_minus2) {
...
export function U(l,m,n,R_1,R_lm1) {

    return P(0,l,m,n,R_1,R_lm1);
}

export function V(l,m,n,R_1,R_lm1) {
...
export function W(l,m,n,R_1,R_lm1) {
...
export function P(i,l,a,b,R_1,R_lm1) {
...
export function yawPitchRoll2Rzyx(yaw, pitch, roll) {
